...
function App() {
  ...
  useEffect(() => {
    axios.get(`${API_BASE_URL}/drivers`).then((res) => setDrivers(res.data)).catch(() => {});
    axios.get(`${API_BASE_URL}/orders`).then((res) => setOrders(res.data)).catch(() => {});
    axios.get(`${API_BASE_URL}/zones`).then((res) => setZones(res.data)).catch(() => {});
